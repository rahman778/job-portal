...
const Dropdown = (props) => {
   ...
   return (
      ...
      >
         ...
         <div
            className={`absolute top-[55px] min-w-full bg-white dark:bg-mediumGrey max-h-56 rounded-md border border-gray-300 dark:border-gray-600 transform transition-all duration-300 ease-in-out shadow-md z-50 overflow-auto ${
