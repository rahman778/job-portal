                        ...
                        <div className="overflow-x-auto">
                           <table className="w-full my-0 align-middle">
                              <thead className="align-bottom border-b border-slate-200 dark:border-slate-700">
                                 <tr>
                                    <th className="pb-3 text-start min-w-[175px] font-medium">
                                       TASK
                                    </th>
                                    <th className="pb-3 text-start min-w-[100px] font-medium">
                                       OWNER
                                    </th>
                                    <th className="pb-3 text-center min-w-[175px] font-medium">
                                       STATUS
                                    </th>
                              ...
                              <tbody>
                                 <tr className="border-b last:border-b-0 border-slate-200 dark:border-slate-700 text-md">
                                    ...
                                    <td className="text-start">
                                       <span className="">Olivia Cambell</span>
                                    </td>
                                    <td className="text-center">
                                       <span className="">In Progress</span>
                                    </td>
                                    <td className="text-center">
                                       <span className="">2023-08-23</span>
                                    </td>
                                 ...
                                 <tr className="border-b last:border-b-0 border-slate-200 dark:border-slate-700 text-md">
                                    ...
                                    <td className="text-end flex items-center justify-end h-[63px]">
                                       ...
                                       <button className="rounded-full w-8 h-8 flex items-center justify-center bg-emerald-600/10 hover-transition hover:bg-emerald-600/30">
                                          <ChevronRightIcon className="w-5 h-5 text-gray-600 dark:text-gray-300 click-transition" />
                                       </button>
                                    </td>
                                 </tr>
